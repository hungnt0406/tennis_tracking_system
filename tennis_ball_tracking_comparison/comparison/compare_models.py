...
def compare(args):
    ...
    checkpoints = {
        ...
        "tracknetv2": args.tracknetv2_ckpt,
        "tracknetv3": args.tracknetv3_ckpt,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tracknetv2_ckpt", default=os.path.join(CHECKPOINT_DIR, "tracknetv2_best.pt"))
    parser.add_argument("--tracknetv3_ckpt", default=os.path.join(CHECKPOINT_DIR, "tracknetv3_inpaint_best.pt"))
