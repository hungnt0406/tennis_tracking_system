"""
Train TrackNetCourt for court keypoint detection.

Usage:
    python -m train.train_tracknet_court [--max_samples N] [--epochs N] [--batch_size N] [--device DEVICE]
"""
...
def train(args):
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        if val_pck > best_pck:
            best_pck = val_pck
            patience_counter = 0
            ckpt = CHECKPOINT_DIR / "tracknet_court_best.pt"
            torch.save(
