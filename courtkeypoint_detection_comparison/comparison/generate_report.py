...
SUMMARY_METRICS = [
    ...
    ("pck@10px",              "PCK@10px"),
    ("pck@25px",              "PCK@25px"),
    ("precision@5px",         "Precision@5px"),
    ("recall@5px",            "Recall@5px"),
    ("f1@5px",                "F1@5px"),
    ("precision@7px",         "Precision@7px"),
    ("recall@7px",            "Recall@7px"),
    ("f1@7px",                "F1@7px"),
    ("mean_kp_error_px",      "Mean KP Err (px)"),
    ("median_kp_error_px",    "Median KP Err (px)"),
    ("max_kp_error_px",       "Max KP Err (px)"),
